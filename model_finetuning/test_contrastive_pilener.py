...
trained_model = GLiNER.from_pretrained("finetuned_gliner_model_non70_500_NCELoss", local_files_only=True)
torch.manual_seed(42)

if torch.cuda.is_available():
    torch.cuda.manual_seed_all(42)

with open("../data/pilener_unlimited_labels/test_100.json", "r", encoding="utf-8") as file:
    processed_output = json.load(file)

with open("../data/pilener_unlimited_labels/test_entity_types_100.json", "r", encoding="utf-8") as file:
