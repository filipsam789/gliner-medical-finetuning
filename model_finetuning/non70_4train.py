...
with open("../new_data/non70/train_processed_outputs_non70_1000_steps.json", "r", encoding="utf-8") as file:
    train_dataset = json.load(file)

with open("../new_data/non70/val_processed_outputs_non70_1000_steps.json", "r", encoding="utf-8") as file:
    val_dataset = json.load(file)

with open("../new_data/non70/val_entity_types_non70_1000_steps.json", "r", encoding="utf-8") as file:
    val_entity_types = json.load(file)
...
trainer.train()
trainer.save_model("finetuned_gliner_model_non70_1000_NCELoss_steps")
